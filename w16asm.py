...
OpcdDict = {"lda":0,"sta":1,"ldi":2,"mov":3,"jmp":4,"jif":5,"inb":6,"outb":7,"push":8,"pop":9,"nop":10,"add":16,"sub":17,"mul":18,"cmp":19,"and":20,"or":21,"xor":22,"not":23,"shl":24,"shr":25,"rol":26,"ror":27,"inc":28,"dec":29}
RegsDict = {"acc":0,"alb":1,"muc":2,"rdw":3,"rew":4,"rfw":5,"rgw":6,"rhw":7,"riw":8,"rjw":9,"rkw":10,"rlw":11,"rmw":12,"rnw":13,"rpw":14,"rqw":15}
...
MemoryOps = [0, 1]; JumpNcOps = [4]; JumpCdOps = [5]
